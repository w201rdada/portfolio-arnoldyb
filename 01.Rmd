...
2. The algorithm would be listening to the wisdom of the crowds, uncovering the most persuasive arguments from both published writers and millions of commentors. Organizations will have a strong incentive to amplify the most persuasive voices of others rather than just their own. This bottom-up approach shows respect for the notion of a [democratic public square](http://courses.ischool.berkeley.edu/i218/s15/calhoun_BPSIntroduction.pdf). 
