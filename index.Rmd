...
```{r hello-world,echo=FALSE,fig.cap='Hello World!',fig.align='center',out.width='100%'}
...
### Abstract: Helping Fantasy Sports Gamers by Grading Pundit Reliability
...
## About the author
```{r hello-me,echo=FALSE,fig.cap='Arnoldy photo',fig.align='left',out.width='100%'}
knitr::include_graphics('img/arnoldy.jpg')
```
