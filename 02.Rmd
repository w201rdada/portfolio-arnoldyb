...
My friend Mark told me recently how he had shelled out $500 for a special scouting report to help improve his Fantasy Football draft picks. Mark is among the 60 million people in North America who are playing fantasy sports this year. Americans spend [$36 billion](http://fsta.org/research/industry-demographics/) each year on fantasy sports, with roughly a tenth of that going to published materials like what Mark bought. That material contains predictions by pundits about how various athletes will perform in the coming week and season; presumably, these predictions will help Mark outperform the average and win the league. 

Mark chose the $500 pundit based on word of mouth and a sense that the information must be good if it costs $500. However, Mark is doing worse this season taking the pundit's advice than he did last season when he was making his own picks. It's easy to laugh and dismiss all pundits as blowhards making guesses like the rest of us. But research says differently. While most forecasters are full of hot air, there is a minority of forecasters who really do [outperform dart-throwing chimps](https://www.washingtonpost.com/news/wonk/wp/2016/01/04/how-to-predict-the-future-better-than-everybody-else/?utm_term=.81864c4dd7c1). 

Using data science, we can measure the track record of correct predictions by various pundits so that fantasy sports gamers can focus their research on the most reliable forecasters, and ultimately, play better.

## Scrape predictions, crowdsource their accuracy {-}

Currently, fantasy gamers have some limited ways to gauge the accuracy of forecasters. Those pundits who make systematic, numerical-only projections across a full set of athletes can be graded relatively simply -- and there are a few (self-interested) [services out there](http://fantasyfootballanalytics.net/2016/03/best-fantasy-football-projections-2016-update.html) doing so. Many predictions, however, are less systematic, focused on just one athlete, or more qualitative in nature. These predictions are often more interesting as they are offered in the course of conversations between pundits or explained in engaging writeups rather than data tables.
 
I am proposing a way to measure the reliability of pundits by applying natural language processing to this unstructured data. This is the process:
...
2) Organize and show the predictions immediately to gamers, along with the pundit's current reliability measure. 
...
There are many areas of life in which people make predictions. Fantasy sports provides one of the easiest areas to determine pundit reliability given the abundance of predictions, their short time intervals, and the motivation of consumers like Mark who care about reliability. 
...
However, even if flaws emerge, the tool's usefulness could be easily measured: Take a random sample of fantasy sports gamers and a control group and compare their overall scores.
If the tool is shown to work for fantasy sports, it could be adapted for more consequential arenas like business risk intelligence, politics, and even government intelligence. Success would be measured in the declining influence of pundits who are consistently wrong. Mark's $500 pundit would be put out of business. Maybe eventually those pundits who predicted Hillary Clinton's win or an easy and cheap U.S. victory in Iraq would fall out of our news feeds. 
