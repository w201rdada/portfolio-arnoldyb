...
However, similar to the “fake news” problem in the general news space, fantasy players lack tools to gauge the accuracy and reliability of what they are reading -- in this case about future events, rather than current events. It's tempting to dismiss forecasting as little more than chance masquerading as reason. Researcher Philip Tetlock has found most forecasters to be worthless at their trade -- except for a quire reliable group of "[superforcasters](https://www.washingtonpost.com/news/wonk/wp/2016/01/04/how-to-predict-the-future-better-than-everybody-else/?utm_term=.81864c4dd7c1)."  
